...
Data import service — CSV, HL7 v2, legacy system migration
...
git clone https://github.com/zarishsphere/zs-svc-import.git
cd zs-svc-import
...
See [docs.zarishsphere.com/api/zs-svc-import](https://docs.zarishsphere.com/api/zs-svc-import) for the full OpenAPI 3.1 specification.
